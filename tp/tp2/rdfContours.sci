...
// param: desc      
//      un vecteur de descripteurs de Fourier précédemment calculé;
// param: ratio 
//      une valeur réelle comprise entre 0 et 1.
//
// Cette fonction renvoie un vecteur de même dimension que desc, mais dont 
// certaines composantes ont été annulées. Le ratio de coefficients annulés
// est indiqué par le deuxième paramètre:
//  -   quand ratio vaut 1, aucun descripteur n'est annulé;
//  -   quand ratio vaut 0, tous les descripteurs retournés sont nuls;
//  -   une valeur de ratio autre indique la proportion de descripteurs qui 
//      sont annulés dans le vecteur (ex: 0.5 indique que la moitié des  
//      descripteurs sont annulés).
