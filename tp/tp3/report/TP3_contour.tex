...
=======
Lorsque nous réduisons le ratio il se trouve que en effet la forme se simplifie (\emph{c.f.}~Fig~\ref{fig:reduction_fourrier})

\begin{figure}[ht]
	\begin{center}
%		\includegraphics[width=10cm]{reduc_chaine_cont.png}
	\end{center}
	\caption{Annulation des descripteurs de Fourrier}
	\label{fig:reduction_fourrier}
\end{figure}


>>>>>>> e391af5bc5364fb1bc9c29678960768ef024e9e3
...
\\
En conclusion je dirai que l'algorithme des cordes n'est pas aussi efficace pour faire de la reconnaissance de formes complexe comme un visage ou une patate que l'algorithme de Fourier. Par contre il est beaucoup plus rapide pour des formes géométriques simples comme un triangle ou un carré.
=======
...
Mais pour ce qui est des formes non connexes (patatoïde) l'algorithme de Fourier est bien plus précis. On observe sur la figure Fig~\ref{fig:comp_cordes} les deux algorithmes et on voit bien que l'algorithme des cordes fait des segment qui sont en dehors de la figure.
