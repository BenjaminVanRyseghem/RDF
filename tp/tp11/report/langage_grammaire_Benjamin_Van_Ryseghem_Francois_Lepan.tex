...
\end{center}
     \caption{Dérivation du mot 'otto'}
\end{figure}

\newpage
\subsection{Implémentation en \pl}
Nous avons deux implémentations  en \pl, l'une basée sur l'inversion d'atome, l'autre sur l'extraction de sous atomes.
