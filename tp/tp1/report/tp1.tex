...
De ce fait, les moments sont eux aussi inverss. Ë cause de cela, deux figures proches ont des moments principaux vraiment diffrents.
...
\end{verbatimtab}
    ...
    \subsection{Calcul des moments principaux d'inertie en diagonalisant la matrice d'inertie calcule ˆ partir des moments centrs normaliss plut™t qu'ˆ partir des moments centrs}
    ???????
